...
.p-12.bg-blue-50.h-full(class="sm:px-2 md:px-12 lg:px-24")
    ...
    form.px-8.pt-6.pb-8.mb-4.bg-white.rounded.my-5
        ...
        .flex.justify-start.my-5
            button.p-3.text-center.text-white.transition.bg-blue-600.rounded.shadow-2xl.ripple(
                :class="['hover:shadow-lg hover:bg-blue-800 focus:outline-none', disableBtn ? 'opacity-40' : '']"
                :disabled="disableBtn"
